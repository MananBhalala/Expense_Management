         ...
         <div class="row">
            <div class="col-lg-12">
               <div class="filter_form">
                  <form type="get">
                     <b>From</b> <input type="date" name="from" value="<?php echo $from ?>" max="<?php echo date('Y-m-d') ?>" onchange="set_to_date()" id="from_date" class="form-control w250">
                     &nbsp;&nbsp;&nbsp;
                     <b>To</b> <input type="date" name="to" value="<?php echo $to ?>" max="<?php echo date('Y-m-d') ?>" id="to_date" class="form-control w250">
